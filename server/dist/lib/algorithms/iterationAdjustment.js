 ...
 * 缩放子项的各项数值
 */
export function scaleItemValues(item, ratio) {
 ...
 * 确保每个子项至少占总投资的1%
 */
export function enforceMinimumShare(items) {
 ...
 * @returns 是否成功应用了调整
 */
export function applyGlobalAdjustment(items, adjustmentTrackers, direction) {
...
//# sourceMappingURL=iterationAdjustment.js.map