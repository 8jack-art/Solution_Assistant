 ...
 */
export function distributeLoanByYear(loanTotal, years) {
    if (years <= 0)
        return [];
    if (years === 1)
        return [loanTotal];
 ...
 */
export function calculateConstructionInterest(buildingInvestment, loanRatio, interestRate, constructionYears, customLoanAmount) {
    let finalLoanAmount;
...
//# sourceMappingURL=loanCalculation.js.map