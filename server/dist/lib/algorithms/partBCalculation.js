 ...
 * @returns 建设工程监理费（万元）
 */
export function calculateSupervisionFee(partATotal) {
 ...
 */
export function calculatePreliminaryConsultingFee(partATotal) {
 ...
 * @returns 勘察设计费（万元）
 */
export function calculateSurveyDesignFee(partATotal) {
