 ...
 */
import { calculateConstructionInterest } from './algorithms/loanCalculation.js';
import { calculatePartB, generatePartAItems } from './algorithms/partCalculation.js';
import { enforceMinimumShare, applyGlobalAdjustment, MAX_ITERATIONS, GAP_THRESHOLD } from './algorithms/iterationAdjustment.js';
// 建设期利息迭代常量
 ...
 * 最终化结果，计算各部分占总投资的比例
 */
function finalizeResult(parts, iterationCount, gapRate) {
...
export function calculateInvestmentEstimate(params) {
    const { projectName, targetInvestment, constructionYears, loanRatio, loanInterestRate, landCost, customLoanAmount, projectType } = params;
    ...
    while (iterationCount < MAX_ITERATIONS) {
        ...
        const direction = gapRate > 0 ? 'decrease' : 'increase';
