 ...
 * 勘察设计费计算
 */
function calculateSurveyDesignFee(engineeringCost: number): number {
...
// 调试：查看分档内插过程
console.log('=== 分档内插调试 ===')
function debugBracketInterpolation(value: number, brackets: Array<{ threshold: number; base: number }>) {
  console.log(`\n计算工程费 ${value} 的基本设计费:`)
